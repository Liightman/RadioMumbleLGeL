...
App::getInstance()->menuActive = "6";
$i= 0;

foreach($playlist as $hit){ $i++; }
?>

<center><h3>Playlist en cours</h3></center>
<div class="alert alert-info">
    L'ordre des titre n'est pas signifiant. Les titres en écoute sont choisis aléatoirement.<br>
    La liste ci-dessous sert de repère des musiques dans la file d'attente de lecture.<br>
    Lorsque la playlist est terminée, elle est automatiquement recréée (avec un random pour le passage des titres).
</div>

<h2>Playlist composée de <b><?= $i ?></b> morceaux.</h2>
